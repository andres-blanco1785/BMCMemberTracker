...
class OfficersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create officer" do
    assert_difference('Officer.count') do
      post officers_url, params: { officer: { amountOwed: @officer.amountOwed, email: @officer.email, name: @officer.name, officerUIN: @officer.officerUIN } }
    end
  ...
  test "should update officer" do
    patch officer_url(@officer), params: { officer: { amountOwed: @officer.amountOwed, email: @officer.email, name: @officer.name, officerUIN: @officer.officerUIN } }
